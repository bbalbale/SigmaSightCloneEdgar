...
| GET | `/analytics/portfolio/{id}/sector-exposure` | ✅ Ready | Sector exposure vs S&P 500 ✨ **NEW** (Phase 1: Risk Metrics) |
| GET | `/analytics/portfolio/{id}/concentration` | ✅ Ready | Concentration metrics (HHI, effective positions) ✨ **NEW** (Phase 1: Risk Metrics) |
| GET | `/analytics/portfolio/{id}/volatility` | ✅ Ready | Volatility analytics with HAR forecasting ✨ **NEW** (Phase 2: Risk Metrics) |
| GET | `/analytics/portfolio/{id}/risk-metrics` | ⚠️ Deprecated | Legacy risk metrics |

**Risk Metrics Phase 1 Endpoints** ✨ **NEW - October 17, 2025**
...
### 📋 Summary Statistics
- **Total Endpoints**: 59 endpoints across 9 categories
- **Production Ready**: 59 (100%)
...
- Data: 10 endpoints
- Analytics: 9 endpoints ✨ **+2 NEW** (sector-exposure, concentration)
...
| **Analytics** | `src/services/analyticsApi.ts` | 6/6 | ✅ 100% | Portfolio analytics endpoints ✨ **+1 NEW** (volatility) |
