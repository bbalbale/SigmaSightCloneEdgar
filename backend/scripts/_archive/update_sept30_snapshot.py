"""
Update Sept 30 snapshot with manually calculated beta from Oct 17 data
"""
...
async def main():
    async with get_async_session() as db:
        ...
        print("=" * 80)
        print("UPDATING SEPT 30 SNAPSHOT WITH BETA CALCULATION")
        print("=" * 80)
        print()
        ...
        print(f"{'Symbol':<8} {'Beta':>8} {'R2':>8} {'Obs':>5} {'MV':>12} {'Weight':>8}")
        print("-" * 60)
        ...
        print(f"Portfolio R2: {float(total_weighted_r_squared):.4f}")
        print(f"Min Observations: {min_observations}")
        print()

        # Update Sept 30 snapshot
        ...
        print(f"SUCCESS: Updated snapshot for {snapshot_date} with beta data")
