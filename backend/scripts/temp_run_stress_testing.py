"""
Temporary Script: Run Stress Testing and Save to Database

Executes comprehensive stress tests for all 3 demo portfolios and saves results.
"""
import asyncio
...
async def main():
    ...
    async with AsyncSessionLocal() as db:
        ...
        for portfolio in portfolios:
            ...
            try:
                ...
                if results.get('stress_test_results', {}).get('skipped'):
                    print(f"⚠️  SKIPPED: {results['stress_test_results'].get('message')}")
                    skip_count += 1
                    continue
                ...
                print(f"✅ Saved {saved_count} stress test results to database")
                success_count += 1
        ...
        if success_count > 0:
            ...
            print(f"\n⚠️  No stress test results were saved to database")
