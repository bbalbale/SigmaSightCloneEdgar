...
EXPECTED_STYLE_FACTOR_COUNT = 6


async def calculate_single_position_ridge_betas(
...
async def calculate_factor_betas_ridge(
    ...
    # Get public positions only (Ridge doesn't apply to PRIVATE or OPTIONS)
    public_positions = [
    ...
    if positions_needing_calculation:
        ...
        if position_returns_df.empty:
            ...
            for position in positions_needing_calculation:
                ...
                result = await calculate_single_position_ridge_betas(
    ...
    results = {
        ...
        'data_quality': {
            ...
            'factors_processed': EXPECTED_STYLE_FACTOR_COUNT
        },
        'metadata': {
        ...
        'storage_results': {
            'position_storage': {
                'records_stored': ridge_diagnostics['positions_calculated'] * EXPECTED_STYLE_FACTOR_COUNT,
                'positions_from_cache': ridge_diagnostics['positions_from_cache']
            },
